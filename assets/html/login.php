...
<body>
	 <?php  
	 	...
	 	{	
	 		...
	 		$login_obj = new LoginPage($email, $password, $PDO);
	 ...
	 <div>
		...
		<?php if(!isset($_REQUEST['email'])){ ?> <a href="registration.php" class="btn btn-primary btn-block btn-lg">Registration</a><br><?php }?>
		<?php if(isset($ssmsg)) { ?>
			<a href="FinancialWork.php" class="btn btn-primary btn-block btn-lg" id='btn__register'>
